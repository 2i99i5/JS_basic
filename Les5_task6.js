let app = {
     ...
     * а также в начале вставляет пустые ячейки, которые идет над/под цифрами.
     */
    insertColsChars() {
     ...
     * @returns {string} 
     */
    getFigure(codeFigure) {
        return `<em>${codeFigure}</em>`;
    },
        /**
    ...
    insertFiguresOnDesk() {
        for (let i = 0; i < positions.length; i++) {
            ...
            let figure = this.getFigure(positions[i].codeFigure);
